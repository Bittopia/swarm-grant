        ...
        <div class="w-full">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-4">
                    <Button as="a" href={`/societies/${societyId}`} color="primary" size="sm" outline={true}>Back</Button>
                </div>
            </div>
        </div>
            ...
            <div class="w-2/3">
                <section class="w-full bg-slate-700 p-8 rounded-lg">
                    <div class="w-full flex items-center justify-between mb-8">
                        ...
                        <Button as="a" href={`/societies/${societyId}/courses/${courseId}/modules/new`} color="primary" size="sm">Add new module</Button>
                    </div>

                    {#if data.modules && Object.keys(data.modules).length > 0}
                        <section class="flex flex-col items-center gap-4">
                            {#each Object.keys(data.moduels) as id}
